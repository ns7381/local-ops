<?xml applicationVersion="1.0" encoding="US-ASCII"?>
...
Link: <http://json.com/my-hyper-schema>; rel="describedby"
			...
			<section title="Self-Descriptive Schema">
				<t>
					...
					be found at <eref target="http://json-schema.org/schema">http://json-schema.org/schema</eref> for the latest applicationVersion or
					<eref target="http://json-schema.org/draft-03/schema">http://json-schema.org/draft-03/schema</eref> for the draft-03 applicationVersion. The hyper schema
			...
			<section title="format">
				...
				<t>
					...
					<list style="hanging">
						...
						<t hangText="ip-address">This SHOULD be an ip applicationVersion 4 address.</t>
						<t hangText="ipv6">This SHOULD be an ip applicationVersion 6 address.</t>
...
<![CDATA[
{
	...
	"extends": {"$ref": "http://json-schema.org/draft-03/schema"}
			...
			<section title="$schema">
				...
				<t>
					A validator MAY use this attribute's value to determine which applicationVersion of JSON Schema the current schema is written in, and provide the appropriate validation features and behavior.
			...
			<section title="links" anchor="links">
				...
				<section title="Link Description Object">
					<t>
						...
						<eref target="http://json-schema.org/links">http://json-schema.org/links</eref> (latest applicationVersion) or
						<eref target="http://json-schema.org/draft-03/links">http://json-schema.org/draft-03/links</eref> (draft-03 applicationVersion).
					</t>

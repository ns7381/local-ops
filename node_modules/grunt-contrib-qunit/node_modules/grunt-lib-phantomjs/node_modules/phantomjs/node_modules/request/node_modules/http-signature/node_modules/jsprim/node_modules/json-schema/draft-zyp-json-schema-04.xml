...
Link: <http://example.com/my-hyper-schema>; rel="describedby"
			...
			<section title="Self-Descriptive Schema">
				<t>
					...
					<eref target="http://json-schema.org/draft-04/schema">http://json-schema.org/draft-04/schema</eref> for the draft-04 applicationVersion. The hyper schema
			...
			<section title="links" anchor="links">
				...
				<section title="Link Description Object">
					<t>
						...
						<eref target="http://json-schema.org/draft-04/links">http://json-schema.org/draft-04/links</eref> (draft-04 applicationVersion).
					</t>
